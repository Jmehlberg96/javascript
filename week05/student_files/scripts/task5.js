...
else {message1 = "WooHoo! It's the weekend!"; }
/* SWITCH, CASE, BREAK */
...
function output(list){
    templeList.forEach(i => {
        let articleElement = document.createElement('article');
        let nameElement = document.createElement('h3');
        nameElement.textContent = i.templeName;
        let locationElement = document.createElement('h4');
        locationElement.textContent = i.location;
        let dedicatedElement = document.createElement('h4');
        dedicatedElement.textContent = i.dedicated;
        let imgElement = document.createElement('img');
        imgElement.src = i.imageUrl;
        imgElement.alt = i.templeName;
